...
import PrevButton from "../home/media_slider/PrevButton";
import NextButton from "../home/media_slider/NextButton";
...
const Story = ({ className, currentSlide, slider, index, storiesList }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-[27.5vw] h-[704px] rounded-10 overflow-hidden relative ${className}`}
      >
        {/* Story */}
        <img
